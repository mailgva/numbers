...
public class NumberRepository {
    ...
    /**
     * Method Get average latency of the Numbers service for all rows
     * @return average value
     */
    public BigDecimal getAvgLatency() {
        Query query = em.createNativeQuery("select avg(number_requests.latency) from number_requests");
